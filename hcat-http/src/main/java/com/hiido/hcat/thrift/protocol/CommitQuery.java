...
public class CommitQuery implements org.apache.thrift.TBase<CommitQuery, CommitQuery._Fields>, java.io.Serializable, Cloneable, Comparable<CommitQuery> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CommitQuery");
  ...
  private static final org.apache.thrift.protocol.TField CONF_FIELD_DESC = new org.apache.thrift.protocol.TField("conf", org.apache.thrift.protocol.TType.MAP, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new CommitQueryStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CommitQueryTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CommitQuery.class, metaDataMap);
  }
   ...
   */
  public CommitQuery(CommitQuery other) {
  ...
  public CommitQuery deepCopy() {
    return new CommitQuery(this);
  }
  ...
  public CommitQuery setCipher(Map<String,String> cipher) {
    this.cipher = cipher;
    return this;
  }
  ...
  public CommitQuery setQuery(String query) {
    this.query = query;
    return this;
  }
  ...
  public CommitQuery setConf(Map<String,String> conf) {
    this.conf = conf;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CommitQuery)
      return this.equals((CommitQuery)that);
    return false;
  }

  public boolean equals(CommitQuery that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CommitQuery other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CommitQuery(");
    boolean first = true;
  ...
  private static class CommitQueryStandardSchemeFactory implements SchemeFactory {
    public CommitQueryStandardScheme getScheme() {
      return new CommitQueryStandardScheme();
    }
  }

  private static class CommitQueryStandardScheme extends StandardScheme<CommitQuery> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CommitQuery struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cipher = new HashMap<String,String>(2*_map0.size);
                String _key1;
                String _val2;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.conf = new HashMap<String,String>(2*_map4.size);
                String _key5;
                String _val6;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CommitQuery struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.cipher != null) {
        oprot.writeFieldBegin(CIPHER_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter8 : struct.cipher.entrySet())
          {
      ...
      if (struct.conf != null) {
        if (struct.isSetConf()) {
          oprot.writeFieldBegin(CONF_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter9 : struct.conf.entrySet())
            {
  ...
  private static class CommitQueryTupleSchemeFactory implements SchemeFactory {
    public CommitQueryTupleScheme getScheme() {
      return new CommitQueryTupleScheme();
    }
  }

  private static class CommitQueryTupleScheme extends TupleScheme<CommitQuery> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CommitQuery struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        oprot.writeI32(struct.cipher.size());
        for (Map.Entry<String, String> _iter10 : struct.cipher.entrySet())
        {
      ...
      if (struct.isSetConf()) {
        {
          ...
          for (Map.Entry<String, String> _iter11 : struct.conf.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CommitQuery struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.cipher = new HashMap<String,String>(2*_map12.size);
        String _key13;
        String _val14;
        for (int _i15 = 0; _i15 < _map12.size; ++_i15)
        {
          ...
          struct.cipher.put(_key13, _val14);
        }
      }
      struct.setCipherIsSet(true);
      struct.query = iprot.readString();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.conf = new HashMap<String,String>(2*_map16.size);
          String _key17;
          String _val18;
