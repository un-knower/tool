...
import com.hiido.hcat.common.util.EmptyOutputStream;
...
public class SQLOperation extends ExecuteStatementOperation {
    ...
    private void setupSessionIO(SessionState sessionState) {
        try {
            ...
            sessionState.out = new PrintStream(new EmptyOutputStream(), true, CharEncoding.UTF_8);
            sessionState.info = new PrintStream(new EmptyOutputStream(), true, CharEncoding.UTF_8);
            sessionState.err = new PrintStream(((HcatSession)parentSession).getErr(), true, CharEncoding.UTF_8);
