    ...
    class EquivalentWorkMatcher implements Dispatcher {
        ...
        */
        ...
        private boolean compareMapWork(MapWork first, MapWork second) {
            Map<String, PartitionDesc> pathToPartition1 = first.getPathToPartitionInfo();
            Map<String, PartitionDesc> pathToPartition2 = second.getPathToPartitionInfo();
            if (pathToPartition1.size() == pathToPartition2.size()) {
                for (Map.Entry<String, PartitionDesc> entry : pathToPartition1.entrySet()) {
