...
public class YARNRunner implements ClientProtocol {
  ...
  public ApplicationSubmissionContext createApplicationSubmissionContext(
    ...
    // TODO gross hack
    //FIXME
    String appMasterClass = conf.get("hadoop.applicationmaster.class");
    if(appMasterClass == null || !appMasterClass.equals("com.hiido.hcat.hadoop.HcatAppMaster")) {
    ...
    vargs.add(conf.get("hadoop.applicationmaster.class", MRJobConfig.APPLICATION_MASTER_CLASS));
    LOG.info("Applicationmaster class is" + conf.get("hadoop.applicationmaster.class", MRJobConfig.APPLICATION_MASTER_CLASS));
