...
import com.hiido.hcat.hadoop.HcatAppMaster;
  ...
  protected void doUnregistration()
    ...
    while (true) {
      ...
      if (response.getIsUnregistered()) {
        ...
        // final states.
    	  //FIXME
    	if(context instanceof RunningAppContext) {
    		RunningAppContext raContext = (RunningAppContext) context;
        	raContext.markSuccessfulUnregistration();
    	} else if(context instanceof HcatAppMaster.RunningAppContext) {
    		HcatAppMaster.RunningAppContext haContext = (HcatAppMaster.RunningAppContext)context;
    		haContext.markSuccessfulUnregistration();
    	}
        break;
      }
